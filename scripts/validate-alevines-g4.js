...
for (const team of ['alevin-c', 'alevin-atunara-a']) {
  ...
  if (!Array.isArray(data.matches) || data.matches.length !== 28) {
    throw new Error('El ' + team + ' no tiene sus 28 partidos oficiales');
  }
  if (!html.includes('Tercera Andaluza Alevín Cádiz · Grupo 4')) {
...
console.log('Los dos calendarios del Grupo 4 son válidos.');
