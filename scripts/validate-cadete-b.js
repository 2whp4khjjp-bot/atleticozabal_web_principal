...
for (const path of ['calendario-cadete-b.html', 'proximos-partidos.html']) {
...
const json = JSON.parse(fs.readFileSync('data/cadete-b-rfaf.json', 'utf8'));
...
console.log('Cadete B verificado: ' + total + ' partidos.');
